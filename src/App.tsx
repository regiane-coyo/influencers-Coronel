...
import { ConciseSummary } from './components/ConciseSummary';
...
export default function App() {
  ...
  const [viewMode, setViewMode] = useState<'summary' | 'grid' | 'table'>('summary');
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* View Mode: Summary (Concise Visual Comparison & Charts) */}
        {viewMode === 'summary' && (
          <ConciseSummary />
        )}
